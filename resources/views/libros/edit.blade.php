...
@section('contenido')
    ...
    {!! Form::open(['route' => ['app.books.update', $book->id], 'method' => 'PUT', 'id'=>'appForm', 'class' => 'form-horizontal']) !!}
        ...
        <div class="col-md-6 text-right">
            <div class="form-group form-actions">
                <div class="col-md-9 col-md-offset-3">
                    ...
                    {!! Form::submit('Editar Libro', ['class' => 'btn btn-sm btn-primary']) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('name', $book->name, ['class' => 'form-control', 'placeholder' => 'Nombre del libro'], 'required') !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('author', $book->author, ['class' => 'form-control', 'placeholder' => 'Autor del libro'], 'required') !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {!! Form::number('quantity', $book->quantity, ['class' => 'form-control', 'placeholder' => 'Cantidad de libros'], 'required') !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('genre', array('1' => 'Drama', '2' => 'Comedia', '3' => 'Accion', '4' => 'Romantica', '5' => 'Novela'), $book->genre, ['class' => 'select-chosen', 'data-placeholder' => 'Seleccione']) !!}
                    </div>
                </div>
