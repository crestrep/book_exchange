...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="block push-bit">
        <!-- Register Form -->
        <form id="form-register" class="form-horizontal form-bordered form-control-borderless" role="form" method="POST" action="{{ url('/register') }}">
            {{ csrf_field() }}
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="gi gi-user"></i></span>
                        <input type="text" id="register-firstname" name="name" value="{{ old('name') }}" class="form-control input-lg" placeholder="Nombre">
                        @if ($errors->has('name'))
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        ...
                        <input type="text" id="register-email" name="email" value="{{ old('email') }}" class="form-control input-lg" placeholder="Email">
                        @if ($errors->has('email'))
                            <span class="help-block">
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="gi gi-asterisk"></i></span>
                        <input type="password" id="register-password-verify" name="password_confirmation" class="form-control input-lg" placeholder="Repetir password">
            ...
            <div class="form-group">
                <div class="col-xs-12 text-center">
                    <small>¿Tienes una cuenta?</small> <a href="{{ url('/login') }}" id="link-register"><small>Login</small></a>
                </div>
            </div>
        </form>
        <!-- END Register Form -->
